import { deleteCustomer, getCustomerById, updateCustomer } from "@/modules/customers/services/mock-data";
import type { CustomerUpdates } from "@/modules/customers/types/customer";
