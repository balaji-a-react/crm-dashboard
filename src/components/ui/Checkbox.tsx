  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="flex items-center justify-center text-current transition-none data-checked:text-primary-foreground data-indeterminate:text-primary-foreground"
      >
        {props.indeterminate ? (
